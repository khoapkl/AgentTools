...
public class OrderPending extends Order
{
    ...
    private String total_total_pending;
    /**
    ...
    /**
     * @return the total_total_pending
     */
    public String getTotal_total_pending()
    {
        return total_total_pending;
    }
    /**
     * @param totalTotalPending the total_total_pending to set
     */
    public void setTotal_total_pending(String totalTotalPending)
    {
        total_total_pending = totalTotalPending;
    }
    /**
     * @return the username
     */
    ...
    /**
     * @param ccType the cc_type to set
     */
