...
import com.dell.enterprise.agenttool.DAO.InventoryCategoryDAO;
...
public class InventoryCategoryService
{
    ...
    {
        InventoryCategoryDAO inventoryCategoryDAO = new InventoryCategoryDAO();
        return inventoryCategoryDAO.getInventoryCategory(category_id);
    }
}
