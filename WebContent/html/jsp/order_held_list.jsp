...
<%
	...
	//out.println(pageRecord + "-" + totalRecord);
%>
<table >
	<tr>
	...
	<tbody>
		<tr>
			...
			Page: <span id="noPage"><%=noPage %></span> of <span id="maxPage"><%=numOfPage %></span></nobr>
		        ...
		        <tr>
            <td><div id="pagingDiv">
                    <input type="Button" value="   &lt;&lt;   " id="firstPage" onclick='movePaging("FIRST","movingHeldByCustomer","held_order_results");'/>
                    <input type="Button" value="   &lt;    " id="prePage" onclick='movePaging("PREV","movingHeldByCustomer","held_order_results");'/>
                    <input type="Button" value="    &gt;   " id="nextPage" onclick='movePaging("NEXT","movingHeldByCustomer","held_order_results");'/>
                    <input type="Button" value="   &gt;&gt;   " id="lastPage" onclick='movePaging("LAST","movingHeldByCustomer","held_order_results");'/>
                    <input type="Button" value=" Requery " onclick='movePaging("FIRST","movingHeldByCustomer","held_order_results");' />
                 </div>
            </td>
        </tr>
	</tbody>
...
<table id="OrderTable" width="100%" cellpadding="2" border="0" class="tablers main">
	...
	<td align="right" colspan="12"><a href="exportOrder.do?method=excelHeldOrder&typehold=CUSTOMER"><font color="red"><u>EXPORT TO EXCEL</u></font></a></td>
	</tr>
		<tr style="background-color:#0099FF">
			...
			<td width="25%" valign="BOTTOM" align="LEFT"><b>Ship to Name</b></td>
    ...
    for (OrderHeld orderHeld : mapOrderHeld) {
       ...
       %>
		<tr style="background-color:<%= style %>">
			...
			<td width="80" valign="TOP" align="center"><%=orderHeld.getItem()%></td>
...
$(document).ready(function() {
	$('#pageTitle').text("Agent store-Held Orders ");
	$('#topTitle').text("Agent store-Held Orders ");
});
</script>
</div>
