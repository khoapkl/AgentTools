...
<table>
	<tr>
		<td colspan="2"><font color="blue"><u><b>Order
		Total:</b></u></font></td>
		<td align="left" colspan="10"><font color="#0000ff"><b><%= totalHeld%></b></font>
		</td>
	</tr>
</table>
<%
...
<table width="600" cellpadding="2" border="0">
	<tbody>
		...
		<tr>
			...
			Held</b></td>
			<td width="10%" valign="BOTTOM" align="left" ><b>Order Total</b></td>
    ...
    for (OrderHeld orderHeld : mapOrderHeld) {
       ...
       %>
		<tr>
			...
			<td valign="TOP" align="left"><%=Converter.getMoney(orderHeld.getTotal_total().divide(BigDecimal.valueOf(100))) %></td>
