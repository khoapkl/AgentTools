...
<%
    Map<Integer, OrderDate> mapMonth = (Map<Integer, OrderDate>) request.getAttribute(Constants.ORDER_MONTH_RESULT);
...
<table width="100%" cellpadding="2" border="0" class="tablers main">
	<tbody>
	<tr>
	<td align="right" colspan="9" bgcolor="#ffffff"><a href="exportOrder.do?method=excelMonthOrder&iyear=<%=year %>&imonth=<%=month %>"><font color="red"><u>EXPORT TO EXCEL</u></font></a></td>
	</tr>
		<tr>
		...
		<tr style="background-color:#CCCCCC">
			<th width="13%" valign="BOTTOM" align="RIGHT" bgcolor="#ffffff"><font
				face="Verdana, Helvetica, Sans-Serif" size="2" bgcolor="#ffffff"> Day </font></th>
			<th width="13%" valign="BOTTOM" align="RIGHT" bgcolor="#ffffff"><font
		...
		<tr style="background-color:<%= style %>">
			<td valign="TOP" align="RIGHT" bgcolor="#ffffff"><a
				href="javascript:void(1)" onclick='getOrderByDay("<%=year %>","<%=month %>","<%=orderDate.getDayNum()%>");'><%=orderDate.getDayNum()%></a></td>
