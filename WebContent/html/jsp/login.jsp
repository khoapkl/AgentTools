...
<![endif]-->
<h3>LOGIN TO CUSTOMER ORDER TOOL</h3>
<div id="wrapper_login">
		...
		<div id="container_login">
			...
			<form action="<%=request.getContextPath()%>/login.do?method=login" method="POST">
				<p>
	...
	<%@include file="/html/scripts/login_script_customer.jsp"%>