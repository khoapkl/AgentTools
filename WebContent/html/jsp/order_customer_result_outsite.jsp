...
<table cellspacing="3" border="0" class="main">
        ...
        <tr>
            <td><div id="pagingDiv">
                    <input type="Button" value="   &lt;&lt;   " id="firstPage" onclick='movePaging("FIRST","movingCustomerOrderOutsite","order_customer_results");'/>
                    <input type="Button" value="   &lt;    " id="prePage" onclick='movePaging("PREV","movingCustomerOrderOutsite","order_customer_results");'/>
                    <input type="Button" value="    &gt;   " id="nextPage" onclick='movePaging("NEXT","movingCustomerOrderOutsite","order_customer_results");'/>
                    <input type="Button" value="   &gt;&gt;   " id="lastPage" onclick='movePaging("LAST","movingCustomerOrderOutsite","order_customer_results");'/>
                    <input type="Button" value=" Requery " onclick='movePaging("FIRST","movingCustomerOrderOutsite","order_customer_results");' />
                 </div>
            </td>
        </tr>
  </tbody></table>
 <%}if(listOrder.size()>0){ %> 
<table id="OrderTable" border=0 cellpadding=2 width=600 class="tablers main">
	<tr>
